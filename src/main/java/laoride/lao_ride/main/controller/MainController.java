...
public class MainController {
    ...
    public String mainPage(Model model) {
        ...
        List<BikeDto> allBikes = new ArrayList<>();

        // 모델 A (총 5대 중 3대 가능)
        allBikes.add(new BikeDto("E-Bike Alpha", "예약 가능", "/images/e-bike-alpha.png"));
        allBikes.add(new BikeDto("E-Bike Alpha", "예약 가능", "/images/e-bike-alpha.png"));
        allBikes.add(new BikeDto("E-Bike Alpha", "예약 가능", "/images/e-bike-alpha.png"));
        allBikes.add(new BikeDto("E-Bike Alpha", "대여 중", "/images/e-bike-alpha.png"));
        allBikes.add(new BikeDto("E-Bike Alpha", "대여 중", "/images/e-bike-alpha.png"));
        // 모델 B (총 3대 중 2대 가능)
        allBikes.add(new BikeDto("E-Bike Bravo", "예약 가능", "/images/e-bike-bravo.png"));
        allBikes.add(new BikeDto("E-Bike Bravo", "예약 가능", "/images/e-bike-bravo.png"));
        allBikes.add(new BikeDto("E-Bike Bravo", "대여 중", "/images/e-bike-bravo.png"));
        // 모델 C (총 2대 모두 대여 중)
        allBikes.add(new BikeDto("E-Bike Charlie", "대여 중", "/images/e-bike-charlie.png"));
        allBikes.add(new BikeDto("E-Bike Charlie", "대여 중", "/images/e-bike-charlie.png"));
        // 모델 D (총 1대 가능)
        allBikes.add(new BikeDto("E-Bike Delta", "예약 가능", "/images/e-bike-delta.png"));
